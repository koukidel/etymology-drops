export const ja = {
    ...
    "firstrun.greeting": "さっそく1つ、単語を割ってみましょう",
    "firstrun.value": "英単語は、部品でできている。\n分ければ、覚えられる。",
    "firstrun.start": "はじめる",
    "firstrun.time": "かかる時間：1分程度",
    ...
    "today.yesterday": "昨日の続きから、はじめましょう。",
    "lesson.complete.tomorrow": "明日、この単語の復習が1問だけ出ます。",
    "guide.final.sub": "この後は、ホームの「今日の一歩」を押すだけです。",
    "hint.dictionary": "出会った部品はここにたまります。部品をタップすると、詳しい説明が見られます。",
    "hint.practice": "レッスンで覚えた部品を、ここで遊びながら鍛えられます。",
    "hint.profile": "学びの記録はここに育っていきます。",
