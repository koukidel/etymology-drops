export const en = {
    ...
    "home.tutorial.title": "How to play",
    ...
    "firstrun.greeting": "Let's crack one word open right away",
    "firstrun.value": "English words are made of parts.\nSplit them, and they stick.",
    "firstrun.start": "Begin",
    "firstrun.time": "Takes about a minute",
    ...
    "today.yesterday": "Pick up where you left off yesterday.",
    "lesson.complete.tomorrow": "Tomorrow, this word comes back for one quick review.",
    "guide.final.sub": "From here on, just press “Today's step” on the home screen.",
    "hint.dictionary": "Every part you meet collects here. Tap a part for its full story.",
    "hint.practice": "Train the parts you've learned here, playfully.",
    "hint.profile": "Your learning record grows here.",
